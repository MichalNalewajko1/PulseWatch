export function bytesToGibibytes(bytes) {
...
export function updateAgentStatus(statusElement,timestamp) {
...
export function updateMetricState(
    cardElement,
    value,
    warningThreshold,
    criticalThreshold
...
export function updateHistoryTable(
    ...
    while (
        historyBodyElement.children.length > 10
    ) {
        historyBodyElement
            .lastElementChild
            .remove();
...
export function renderLatestSnapshot(snapshot) {
    const statusElement =
